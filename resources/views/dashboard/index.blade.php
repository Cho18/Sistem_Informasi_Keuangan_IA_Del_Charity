...
@section('contents')
    ...
    <div class="row">
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary"> Perbandingan per Tahun</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    ...
                    <div class="mt-4 text-center small">
                        ...
                        <span class="mr-2">
                            <i class="fas fa-circle text-danger"></i> Balance
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-12 col-lg-7">
            <div class="card shadow mb-4">
                ...
                <div
                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary"> Jumlah Pengeluaran </h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    <div class="chart-area">
    ...
    <script type="text/javascript">
        ...
        var tpemasukan = JSON.parse('{!! json_encode($total_pemasukan) !!}');
        var bpemasukan = JSON.parse('{!! json_encode($bulan_pemasukan) !!}');
    ...
    <script type="text/javascript">
        ...
        var tpengeluaran = JSON.parse('{!! json_encode($total_pengeluaran) !!}');
        var bpengeluaran = JSON.parse('{!! json_encode($bulan_pengeluaran) !!}');
    ...
    <script type="text/javascript">
        ...
        var jpengeluaran = JSON.parse('{!! $encodedJpengeluaran !!}');
        var tpengeluaran = JSON.parse('{!! $encodedTpengeluaran !!}');
        var ctx = document.getElementById("pengeluaran2");
        var myLineChart = new Chart(ctx, {
        type: 'line',
        data: {
            labels: jpengeluaran,

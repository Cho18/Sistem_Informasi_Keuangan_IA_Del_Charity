...
@section('title', 'Jenis Pemasukan')

@section('pemasukan_dana', 'active')
@section('pemasukan', 'show')
@section('jenis_pemasukan', 'active')
...
@if (session()->has('success'))
    ...
    <div class="card shadow mt-2">
        <div class="card-header py-3">
            <h3 class="m-0 font-weight-bold text-primary text-center"> Daftar Jenis Pemasukan </h3>
            <div class="modal-footer clearfix">
                <div class="float-left">
                    ...
                    @include('pemasukan_dana.jenis_pemasukan.add')
                </div>
                <div class="float-right">
                    <a href="#" type="button" class="btn btn-success me-md-2" id="exportBtn" data-export="/export_jenis_pemasukan">
                ...
                <table class="table table-bordered table-hover border-secondary text-gray-900" id="dataTable">
                    <thead>
                        <tr style="text-align:center;">
                            ...
                            <th><b> Deskripsi Jenis Pemasukan </b></th>
                            <th><b> Aksi </b></th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($jenis_pemasukan as $index => $jp)
                            <tr>
                                <td style="text-align:center;">  {{ $loop->iteration }} </td>
                                <td>  {{ $jp->name_of_type_income }} </td>
                                <td align="justify">  {!! $jp->description_of_type_income !!} </td>
                                <td>
                                    ...
                                    @include('pemasukan_dana.jenis_pemasukan.delete')
                                </td>
                            </tr>
                            @include('pemasukan_dana.jenis_pemasukan.edit')
